...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_6x15( /* Base */
        ...
        _______, RF_BT1,     RF_BT2,   RF_BT3,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_INS,   _______,  QK_DEBUG_TOGGLE,
        _______,  RF_PR_1,    RF_PR_2,  RF_PR_3,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
